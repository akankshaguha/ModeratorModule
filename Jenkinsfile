...
step([$class: 'CopyArtifact', fingerprintArtifacts: true, flatten: true, projectName: 'ModeratorModule/', selector: [$class: 'StatusBuildSelector', stable: false], target: '../ModeratorModule/repo'])
